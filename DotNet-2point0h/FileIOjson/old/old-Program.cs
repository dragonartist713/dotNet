...
// Console.WriteLine($"{personA.FullName} position BEFORE: {companyA.Position.Description}}")

// personA.Position.Description = "Architect"

// Console.WriteLine($"{personA.FullName} position After: {companyA.Position.Description}}")
